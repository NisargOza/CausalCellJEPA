# Run the one-time reporting-only evaluation of the frozen multimodal selection.
...
config = yaml.safe_load(Path("configs/evaluation_multiteacher.yaml").read_text())
assert _git_state()["dirty"] is False, "Full reporting evaluation requires a clean commit"
