# Fit and freeze the exploratory STRING+GO kernel student on K562 train/validation only.
# The command performs no sealed or RPE1 perturbed-outcome evaluation.
import json
...
config_path = Path("configs/string_kernel_gene.yaml")
