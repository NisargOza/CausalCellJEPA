# Train or exactly resume both frozen contextual-fusion candidates on one GPU.
import json
import os
...
assert torch.cuda.is_available(), "Full contextual dynamics training requires CUDA"
assert _git_state()["dirty"] is False, "Full contextual training requires a clean commit"
