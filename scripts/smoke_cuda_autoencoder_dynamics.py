# Require a short fresh-process CUDA checkpoint/resume gate before full autoencoder dynamics.
# This remains bounded to 64 optimizer steps and two validation batches.
import json
