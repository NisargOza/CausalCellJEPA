# Run exact CPU resume and full-epoch gates for the learned target-ID comparator.
import json
...
_, epoch_state, epoch_report = train_dynamics(
    epoch_config, torch.device("cpu"), config_path="configs/learned_target_id.yaml"
)
