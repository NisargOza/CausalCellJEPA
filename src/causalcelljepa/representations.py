# Matched reconstruction state baseline using the frozen expression/split protocol.
# Only representation-permitted cells may enter optimization or model selection.
import json
import math
import time
